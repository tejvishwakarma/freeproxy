...
class AddCountryWidget extends StatefulWidget {
  const AddCountryWidget({
    super.key,
    required this.countryUpdate,
  });

  final CountryRecord? countryUpdate;
...
class _AddCountryWidgetState extends State<AddCountryWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view', parameters: {'screen_name': 'addCountry'});
                              ...
                              onPressed: () async {
                                await CountryRecord.collection
                                    ...
                                    .set(createCountryRecordData(
                                      ...
                                      countryFlag: functions.stringToImagePath(
                                ...
                                context.pushNamed(
                                  ...
                                  queryParameters: {
                                    'countryUpdate': serializeParam(
                                      widget.countryUpdate?.reference,
