...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFF05B57);
  late Color secondary = const Color(0xFFEC1B69);
  late Color tertiary = const Color(0xFFEB9C99);
  ...
  late Color primaryBackground = const Color(0xFF1D1029);
  ...
  late Color success = const Color(0xFF0F8E4F);
  late Color warning = const Color(0xFFC96F46);
  late Color error = const Color(0xFFD9323C);
  late Color info = const Color(0xFF1C4494);

  late Color textField = const Color(0xFF3F215A);
  late Color appBackground = const Color(0xFF360F58);
}
